...
#	def OnOptionsPagesAdd(self, Pages=defaultNamedNotOptArg, Folder=defaultNamedNotOptArg):
#	def OnAutoDiscoverComplete(self):


win32com.client.CLSIDToClass.RegisterCLSID( "{0006308C-0000-0000-C000-000000000046}", NameSpaceEvents )
