...
class Links(DispatchBaseClass):
	...
	def Add(self, Item=defaultNamedNotOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, u'Add', '{00063089-0000-0000-C000-000000000046}')
		return ret
	...
	def Item(self, Index=defaultNamedNotOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, u'Item', '{00063089-0000-0000-C000-000000000046}')
		return ret
...
win32com.client.CLSIDToClass.RegisterCLSID( "{0006308A-0000-0000-C000-000000000046}", Links )
# -*- coding: mbcs -*-
# Created by makepy.py version 0.5.00
# By python version 2.5.4 (r254:67916, Dec 23 2008, 15:10:54) [MSC v.1310 32 bit (Intel)]
# From type library '{00062FFF-0000-0000-C000-000000000046}'
...
Links_vtables_ = [
	...
	(( u'Add' , u'Item' , u'Link' , ), 95, (95, (), [ (9, 1, None, None) , 
			(16393, 10, None, "IID('{00063089-0000-0000-C000-000000000046}')") , ], 1 , 1 , 4 , 0 , 52 , (3, 0, None, None) , 0 , )),
	(( u'Remove' , u'Index' , ), 84, (84, (), [ (12, 1, None, None) , ], 1 , 1 , 4 , 0 , 56 , (3, 0, None, None) , 0 , )),
]
