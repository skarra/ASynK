...
class UserProperties(DispatchBaseClass):
	...
	def Add(self, Name=defaultNamedNotOptArg, Type=defaultNamedNotOptArg, AddToFolderFields=defaultNamedOptArg, DisplayFormat=defaultNamedOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, u'Add', '{00063042-0000-0000-C000-000000000046}')
		return ret
	...
	def Find(self, Name=defaultNamedNotOptArg, Custom=defaultNamedOptArg):
		ret = self._oleobj_.InvokeTypes(103, LCID, 1, (9, 0), ((8, 1), (12, 17)),Name
			, Custom)
		if ret is not None:
			ret = Dispatch(ret, u'Find', '{00063042-0000-0000-C000-000000000046}')
		return ret
	...
	def Item(self, Index=defaultNamedNotOptArg):
		...
		if ret is not None:
			ret = Dispatch(ret, u'Item', '{00063042-0000-0000-C000-000000000046}')
		return ret
...
win32com.client.CLSIDToClass.RegisterCLSID( "{0006303D-0000-0000-C000-000000000046}", UserProperties )
# -*- coding: mbcs -*-
# Created by makepy.py version 0.5.00
# By python version 2.5.4 (r254:67916, Dec 23 2008, 15:10:54) [MSC v.1310 32 bit (Intel)]
# From type library '{00062FFF-0000-0000-C000-000000000046}'
...
UserProperties_vtables_ = [
	...
	(( u'Add' , u'Name' , u'Type' , u'AddToFolderFields' , u'DisplayFormat' , 
			u'UserProperty' , ), 102, (102, (), [ (8, 1, None, None) , (3, 1, None, None) , (12, 17, None, None) , 
			(12, 17, None, None) , (16393, 10, None, "IID('{00063042-0000-0000-C000-000000000046}')") , ], 1 , 1 , 4 , 2 , 52 , (3, 0, None, None) , 0 , )),
	(( u'Find' , u'Name' , u'Custom' , u'UserProperty' , ), 103, (103, (), [ 
